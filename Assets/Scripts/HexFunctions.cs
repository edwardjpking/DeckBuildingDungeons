...
public class HexFunctions : MonoBehaviour
{
    ...
    */
    ...
    public Vector3Int[,] oDD = {
        {
            new Vector3Int(-1, -1, cnst.z), // dl - 0
            new Vector3Int(-1, 0, cnst.z), // down - 1
            new Vector3Int(-1, 1, cnst.z), // dr - 2
            new Vector3Int(0, 1, cnst.z), // ur - 3
            new Vector3Int(1, 0, cnst.z), // up - 4
            new Vector3Int(0, -1, cnst.z) // ul - 5
        },
        {
            new Vector3Int(0, -1, cnst.z), // dl - 0
            new Vector3Int(-1, 0, cnst.z), // down - 1
            new Vector3Int(0, 1, cnst.z), // dr - 2
            new Vector3Int(1, 1, cnst.z), // ur - 3
            new Vector3Int(1, 0, cnst.z), // up - 4
            new Vector3Int(1, -1, cnst.z) // ul - 5
        }
    };
    ...
    public Vector3Int axialToOffset(Vector2Int hex) {
        ...
        return new Vector3Int(col, row, cnst.z);
    }
    ...
    public List<Vector3Int> allHexesAtDistance(Vector3Int centreHex, int dist) {
        ...
        for (int layerIdx = 1; layerIdx<dist+1; ++layerIdx) {
            ...
            if (offsetDistance(currentHex, origin) < 4) {
                hex_list.Add(currentHex);
            }
